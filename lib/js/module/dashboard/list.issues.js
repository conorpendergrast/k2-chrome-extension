    ...
    return (
      <div className="issueList">
        ...
        <div className="legend">
          ...
          <div className="issue"><span className="octicon octicon-bug"></span> Bug</div>
          <div className="issue"><span className="octicon octicon-checklist"></span> Task</div>
          <div className="issue"><span className="octicon octicon-gift"></span> Feature</div>
        </div>
