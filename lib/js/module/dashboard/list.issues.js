  ...
  render() {
    ...
    return (
      <div className="issueList">
        ...
        <br />
        <div>
          <PanelList title="Pull Requests - Being reviewed" action={ActionsPullAssigned} store={StorePullAssigned} options={{showAssignee: false, showReviews: true}} item="pull" pollInterval={this.props.pollInterval} />
        </div>
        <br />
        <div>
