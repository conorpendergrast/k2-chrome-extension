  ...
  render() {
    ...
    return (
      <div className="issueList">
        ...
        <br />
        <div>
          <PanelList title="Pull Requests - You created and need to merge" action={ActionsPullAssigned} store={StorePullAssigned} options={{showAssignee: false, showReviews: true}} item="pull" pollInterval={this.props.pollInterval} />
        </div>
        <br />
        <div>
          <PanelList title="Pull Requests - You need to review" action={ActionsPullReviewing} store={StorePullReviewing} options={{showAssignee: false}} item="pull" pollInterval={this.props.pollInterval} />
        </div>
        <br />
        <div>
          <Tabs
